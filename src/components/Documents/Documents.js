...
const Documents = () => {
  ...
  const downloadResumeSample = () => {
    // Create a ValueMomentum resume template
    const resumeContent = `
VALUEMOMENTUM RESUME TEMPLATE
...
[Write a brief professional summary highlighting your key skills, experience, 
and career objectives. Keep it concise (3-4 lines).]
...
Programming Languages: _______________________________________________________

Frameworks & Tools: __________________________________________________________

Databases: ___________________________________________________________________

Cloud Platforms: _____________________________________________________________

Other Technologies: __________________________________________________________
...
[Degree Name]
[University/Institution Name]                          [Year]
...
Awards & Recognition: ________________________________________________________

Other Relevant Information: ___________________________________________________

================================================================================

Note: Please fill out this template and convert it to PDF or Word format before uploading.
Ensure all information is accurate and up-to-date.

Generated by ValueMomentum HR Onboarding System
`;
    ...
    link.href = url;
    link.download = 'ValueMomentum_Resume_Template.txt';
