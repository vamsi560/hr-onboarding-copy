...
import OfferLettersDashboard from '../TAG/OfferLetters/OfferLettersDashboard';
import OfferLetterForm from '../TAG/OfferLetters/OfferLetterForm';
import OfferLetterPreviewPage from '../TAG/OfferLetters/OfferLetterPreviewPage';
          ...
          <Routes>
            ...
            {userRole === 'tag' && (
              <>
                ...
                <Route path="/offer-letters" element={<OfferLettersDashboard />} />
                <Route path="/offer-letters/new" element={<OfferLetterForm />} />
                <Route path="/offer-letters/edit/:id" element={<OfferLetterForm />} />
