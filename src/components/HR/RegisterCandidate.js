      ...
      <Card>
        ...
        <form onSubmit={handleSubmit}>
          <div className="form-group position-id-group">
            <label htmlFor="positionSelect">Position ID *</label>
            <select
              id="positionSelect"
          ...
          <div className="form-row">
            <div className="form-group">
              <label htmlFor="dojInput">Date of Joining *</label>
              <Input
                id="dojInput"
                type="date"
          ...
          <div className="form-row">
            <div className="form-group">
              <div className="label-text">Joining Bonus Applicable</div>
              <div className="radio-group">
                <label htmlFor="field_322" className="radio-option">
                  <input id="field_322"
                    type="radio"
                    name="joiningBonus"
                    value="yes"
                ...
                <label htmlFor="field_332" className="radio-option">
                  <input id="field_332"
                    type="radio"
                    name="joiningBonus"
                    value="no"
            ...
            <div className="form-group">
              <div className="label-text">Relocation Assistance</div>
              <div className="radio-group">
                <label htmlFor="field_347" className="radio-option">
                  <input id="field_347"
                    type="radio"
                    name="relocation"
                    value="yes"
                ...
                <label htmlFor="field_357" className="radio-option">
                  <input id="field_357"
                    type="radio"
                    name="relocation"
                    value="no"
          ...
          {formData.joiningBonus === true && (
            <div className="form-group">
              <div className="label-text">Joining Bonus Details</div>
          ...
          {formData.relocation && (
            <div className="form-group">
              <label htmlFor="relocationCitySelect">Relocation City *</label>
              <select
                id="relocationCitySelect"
                className="input"
          ...
          <div className="form-section-divider" style={{ marginTop: '32px', marginBottom: '24px', borderTop: '1px solid #e0e0e0', paddingTop: '24px' }}>
            ...
            <div className="form-row">
              <div className="form-group">
                <div className="label-text">Resume</div>
              ...
              <div className="form-group">
                <div className="label-text">PAN Card</div>
                <div className="file-upload-wrapper">
                  <input
                    type="file"
