        ...
        {showAddForm && (
          <Card className="reference-form-card">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="form-row">
                <div className="form-group">
                  <label htmlFor="refNameInput">Reference Name *</label>
                  <Input
                    id="refNameInput"
                ...
                <div className="form-group">
                  <label htmlFor="refEmailInput">Reference Email *</label>
                  <Input
                    id="refEmailInput"
                    type="email"
              ...
              <div className="form-row">
                <div className="form-group">
                  <label htmlFor="refPhoneInput">Reference Phone</label>
                  <Input
                    id="refPhoneInput"
                    type="tel"
              ...
              <div className="form-row">
                ...
                <div className="form-group">
                  <label htmlFor="relationshipSelect">Relationship *</label>
                  <select
              ...
              <div className="form-group">
                <label htmlFor="requestDateInput">Request Date *</label>
                <Input
                  id="requestDateInput"
                  type="date"
...
const ResponseForm = ({ refId, onUpdate }) => {
  ...
  return (
    <form onSubmit={handleSubmit}>
      <div className="form-group">
        <label htmlFor="ratingSelect">Rating (1-5) *</label>
        <select
          id="ratingSelect"
          className="input"
          value={rating}
